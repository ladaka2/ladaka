...
<script src="js/goRegist3.js" type="text/javascript" charset="utf-8"></script>
	...
	<div class="container">
		...
		<div class="registForm" style="float: left; margin-bottom: 30px;">
			<div style="float: left;">
					<span>사업자 분류 선택*</span>
					<div>
						<input type="text" name="str_cate" id="str_cate" style="width: 100px;" disabled value="피트니스">
						<select style="width: 100px; margin-right: 10px" name="selectCate" id="selectCate">
							<option value="피트니스" selected>피트니스</option>
			...
			<div>
				<span>사업자 등록 번호*</span>
				<div class="notice">
					<span>(아이디로 사용함, 직영점이 여러 개일 경우 일련번호에 순번기입)</span>
				</div>
				<div>
			...
			<div>
				...
				<div class="notice">
					<span>비밀번호 찾기시 등록한 이메일로 임시비밀번호를 보내드리니 정확하게 입력하셔야 합니다.</span>
				</div>
			</div>
			...
			<div style="float: left;">
				<span>소개 키워드</span>
				<textarea id="businessKeyword" style="width: 94%;" rows="5" cols="100" placeholder="사업자 회원분들의 전문 분야와 소개글을 (예 : 다이어트, 피부 관리, 네일 아트, 두피 관리, 키성장 등) 40자 이내로 입력해 주세요."></textarea>
			</div>
